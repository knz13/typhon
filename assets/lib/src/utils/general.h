...
#include "../auxiliary_libraries_helpers/auxiliary_libraries_interface.h"
#include <bitset>
#include <functional>
#include <sstream>
#include "color.h"
...
namespace HelperFunctions
{
    ...
    static std::string GetStringFromStringStreamFunction(std::function<void(std::stringstream &ss)> func)
    {
        std::stringstream ss;
        func(ss);
        return ss.str();
