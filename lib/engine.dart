...
import 'features/project_initialization/data/project_model.dart';
...
class Engine {
  ...
  Future<void> saveProjectsJSON(List<ProjectModel> projects) async {
    ...
    var mapToSave = Map<String, dynamic>.fromEntries(
        projects.map((e) => MapEntry(e.location, e.toJson())));
  ...
  Future<void> initializeProject(
    ...
    if (projectsList
        .where((element) => element.location == projectPath)
        .isNotEmpty) {
...
extern "C" {
  ...
  //__BEGIN__CPP__EXPORTS__
    ...
    TYPHON_EXPORT void passPlatformSpecificViewPointer(void *view);
