  ...
  Container middleTileMenu(MiddleTile middleTile) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(5),
          border: selectedMiddleOptionMenu == middleTile.idx
              ? Border.all(width: 3, color: Colors.blue)
              : Border.all(width: 3, color: Colors.transparent)),
      child: RawMaterialButton(
        onPressed: () {
          setState(() {
            selectedMiddleOptionMenu =
                selectedMiddleOptionMenu == middleTile.idx
                    ? -1
                    : middleTile.idx;
          });
        },
        child: Center(
          child: ListTile(
            ...
            subtitle: Text(
              middleTile.subtitle,
              style: const TextStyle(
                  fontSize: 16, letterSpacing: 0, color: Colors.white54),
            ),
          ),
        ),
      ),
                          ...
                          RawMaterialButton(
                            onPressed: () {
                              ...
                              if (projectLocationPath == null) {
                                showToast(
                                    "Please Provide a Valid Project Location",
                                    context: context);
                                return;
                              }
                              ...
                              Future.delayed(Duration(milliseconds: 500), () {
                                Engine.instance.initializeProject(
                                    projectLocationPath!, projectName!);
                              });
                            },
                            child: Container(
                              height: 40,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: FutureBuilder(
                      future: Engine.instance.getProjectsJSON(),
                      builder: (context, snapshot) {
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            if (snapshot.hasData &&
                                !Directory(snapshot.data!.keys.toList()[index])
                                    .existsSync()) {
                              ...
                              child: MaterialButton(
                                onPressed: () async {
                                  Future.delayed(Duration(milliseconds: 500),
                                      () {
                                    Engine.instance.initializeProject(
                                        path.dirname(snapshot.data!.keys
                                            .toList()[index]),
                                    ...
                                    children: [
                                      ...
                                      ProjectListItem(
                                          text: snapshot.data![snapshot
                                              ...
                                              .toList()[index]]["name"],
                                          flex: 2,
                                          subtitleText: snapshot.data!.keys
                                              .toList()[index]),
                                      ProjectListItem(
                                          text: "some date", flex: 2),
                                      ProjectListItem(
                                          text: "",
                                          child: MaterialButton(
                                            minWidth: 10,
...
class ProjectHeaderItem extends StatelessWidget {
  ProjectHeaderItem({super.key, required this.text, this.flex});
